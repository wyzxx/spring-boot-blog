    ...
    $.ajax(
        {
            ...
            success(result) {
                ...
                result.forEach(k => {
                    console.log(k);
                    createArticle(k.blogArticleInfo.id,k.blogArticleInfo.title,k.category,k.blogArticleInfo.createBy.substr(0,10),k.blogArticleInfo.imgUrl);
                });
            }
        });


    var createArticle = function(id,title,category,createBy,imgUrl){
